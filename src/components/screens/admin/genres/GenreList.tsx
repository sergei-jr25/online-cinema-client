...
const GenreList: FC = () => { 
 ...
 return ( 
    <div>
       <AdminNavigation/>
       <AdminHeader handleSerach={handleSearch} searchTerm={searchTerm} onClick={createAsync} />
       <AdminTable isLoading={isLoading } removeHanlder={ deleteAsync} headerItems={ ['Title' ,'slug']} tableItems={data || []} />
 </div> 
 ) 
} 
